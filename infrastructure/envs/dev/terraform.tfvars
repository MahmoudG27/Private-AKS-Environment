...
agent_vm_os_disk_size_gb = 32                # OS Disk size in GB
...
aks_version      = "1.32.9"               # Kubernetes version
...
agent_pool_vm_size        = "Standard_DS2_v2" # VM size for the agent nodes
...
user_pool_vm_size        = "Standard_DS2_v2" # VM size for the user nodes
